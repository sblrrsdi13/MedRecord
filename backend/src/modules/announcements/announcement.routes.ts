...
import { createAnnouncement, deleteAnnouncement, listAnnouncements, listPublicAnnouncements, updateAnnouncement } from "./announcement.controller.js";
import { announcementSchema } from "./announcement.schema.js";

export const announcementRoutes = Router();

announcementRoutes.get("/public", listPublicAnnouncements);
