...
export default function HomePage() {
  ...
  useEffect(() => {
    document.title = cms.seoTitle;
    upsertMeta("description", cms.seoDescription);
    upsertMeta("keywords", cms.seoKeywords);
    upsertFavicon(cms.faviconUrl);
  }, [cms.faviconUrl, cms.seoDescription, cms.seoKeywords, cms.seoTitle]);
